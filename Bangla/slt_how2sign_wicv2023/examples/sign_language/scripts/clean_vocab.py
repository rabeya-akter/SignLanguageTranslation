...
#from bnlp import NLTKTokenizer, BengaliPunctuator, BengaliNormalizer
#from bnlp import NLTKTokenizer, BengaliSpellChecker
import nltk
...
def clean_how2sign_vocabulary(path_to_data_sentencelevel):
    ...
    mpn = MosesPunctNormalizer(lang='de')
    ...
    for index, row in tqdm(data.iterrows(), total=data.shape[0]):
        ...
        #sentence = truecase.get_true_case(sentence) changed by safa
...
if __name__ == "__main__":
    path_to_data_sentencelevel = {'val': "/media/rmedu/Softwares/RabeyaAkter/slt_how2sign_wicv2023/data/how2sign/i3d_features/cvpr23.fairseq.i3d.val.how2sign.tsv",\
                                  'test': "/media/rmedu/Softwares/RabeyaAkter/slt_how2sign_wicv2023/data/how2sign/i3d_features/cvpr23.fairseq.i3d.test.how2sign.tsv",\
                                  'train': "/media/rmedu/Softwares/RabeyaAkter/slt_how2sign_wicv2023/data/how2sign/i3d_features/cvpr23.fairseq.i3d.train.how2sign.tsv"\
    }
